 ...
 */
function initialImageUpload($container, w, h, url, imgLoadCallback, imgUnloadCallback) {

  var croppable = false;

  var $loader = $container.find(".loader").show();
  ...
  var $chooser = $container.find(".img-upload-chooser input[type=file]");
